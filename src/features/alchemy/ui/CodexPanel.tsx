...
import { ITEMS, ITEM_LIST } from '@/game/content/items';
...
export function CodexPanel() {
  ...
  const discoveredRecipesCount = state.discoveredRecipes.length;
    ...
    <div className="codex-panel">
      <div className="codex-header">
        ...
        <span className="codex-progress">
          {discoveredCount}/{totalItems} 物品 · {discoveredRecipesCount}/{totalRecipes} 配方
        </span>
      </div>
